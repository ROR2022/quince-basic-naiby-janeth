...
export function ParentsScene({ onComplete, isActive = true }: ParentsSceneProps) {
  ...
  const secondMessage = "Sociedad Aurora"
  const thirdMessage = "20:30 hrs."
  const fourthMessage = "C. 17 97C entre 20 y 22 24900 Centro, Centro, Calkiní, Campeche"
  const fifthMessage = "Baile y Fiesta"
  const ubiLink = "https://maps.app.goo.gl/GXyfF6RWDei35Pqq7"
