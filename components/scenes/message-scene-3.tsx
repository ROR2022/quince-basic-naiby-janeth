...
export function MessageScene3({ onComplete, isActive = true }: MessageScene3Props) {
  ...
  const secondMessage = "Iglesia de San Luis Obispo"
  const thirdMessage = "19:00 hrs."
  const fourthMessage = "C. 17, Centro, Calkiní, Campeche"
  const fifthMessage = "Misa de Acción de Gracias"
  const ubiLink = "https://maps.app.goo.gl/8KGKgRcwMdBa1ARf9"
